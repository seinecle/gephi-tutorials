...
Clément Levallois <analysis@exploreyourdata.com>; Matthieu Totet <matthieu.totet@gmail.com>
2017-01-31
...
image::twitter-user-list.jpg[align="center", title="How to add user from a Twitter List"]
...
image::geo_params.jpg[align="center", title="How to add a Locations"]
...
image::emoji-change-font.png[align="center", title="Change font for Emoji display"]
...
image::result-plugin-1-en.png[align="center",title="Users mentioned in or retweeting tweets citing the search terms"]
...
image::timeline-enable.png[align="center", title="How to activate the Timeline"]

image::timeline.gif[align="center", title="Example of Timeline"]
